...
public enum CommandEnum {
    ...
    SHOW_EDIT_PAGE("show_edit_page", AccessLevel.CUSTOMER, AccessLevel.BARMEN,
            AccessLevel.ADMINISTRATOR),
    SHOW_CUSTOMER_LIST("show_customer_list", AccessLevel.CUSTOMER,AccessLevel.BARMEN,
            AccessLevel.ADMINISTRATOR),
    CHANGE_PASSWORD("change_password", AccessLevel.CUSTOMER,AccessLevel.BARMEN,
            AccessLevel.ADMINISTRATOR),
    SHOW_UPDATE_COCKTAIL_PAGE("show_update_cocktail_page",AccessLevel.CUSTOMER,AccessLevel.BARMEN,
            AccessLevel.ADMINISTRATOR),
    EDIT_PROFILE("edit_profile", AccessLevel.CUSTOMER,AccessLevel.BARMEN,
            AccessLevel.ADMINISTRATOR),
